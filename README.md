## Запуск
Чтобы запустить приложение, вам необходимо добавить файл .env с необходимыми переменными среды, собрать контейнер с помощью «docker build» и запустить контейнер.
